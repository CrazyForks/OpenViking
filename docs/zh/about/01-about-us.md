...
开源治理委员会负责技术路线、核心架构评审、工程规范和社区协作。成员包括 Haojie Qin、Jiahui Zhou、Linggang Wang、Maojia Sheng、Yaohui Sun。

功能建议和问题在 [GitHub Issues](https://github.com/volcengine/OpenViking/issues) 讨论，代码与文档变更通过 Pull Request 评审。
